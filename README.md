...
- `.github/workflows/ci.yml`
  ...
  - supports manual semver bump releases and tag-based GitHub Releases
...
The 2.0 planning and feature direction in this repo also drew additional inspiration from the following projects:
