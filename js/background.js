...
(function(root) {
  ...
  function normalizeExtensions(items, state) {
    ...
    // Bolt Optimization: Convert arrays to Sets/Maps for O(1) lookups during iteration
    // Reduces overall mapping complexity from O(N*M) to O(N+M)
  ...
  async function runApplyProfile(profileName) {
    ...
    // Bolt Optimization: Use Set for O(1) lookups during iteration
